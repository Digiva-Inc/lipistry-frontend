  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn max-w-[1400px] mx-auto bg-[#fbfaf9]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <div
          className="stat-card group bg-white p-4 rounded-2xl border-2  flex flex-col items-start gap-3 shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md hover:shadow-blue-100 border-blue-200 cursor-default"
        ...
        >
          <div className="flex items-center gap-3 w-full">
            ...
            <div>
              ...
              <span className="stat-number text-2xl font-black text-slate-900 leading-none block">
                {stats?.totalReps || 0}
              </span>
            </div>
          </div>
        ...
        <div
          className="stat-card group bg-white p-4 rounded-2xl border-2 flex flex-col items-start gap-3 shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md hover:shadow-rose-100 border-rose-200 cursor-default"
          style={{ animationDelay: "80ms" }}
        >
          <div className="flex items-center gap-3 w-full">
            <div className="stat-icon w-10 h-10 rounded-full bg-rose-50 flex items-center justify-center shrink-0">
        ...
        <div
          className="stat-card group bg-white p-4 rounded-2xl border-2  flex flex-col items-start gap-3 shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md hover:shadow-amber-100 border-amber-200 cursor-default"
        ...
        <div
          className="stat-card group bg-white p-4 rounded-2xl border-2 flex flex-col items-start gap-3 shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md hover:shadow-indigo-100 border-indigo-200 cursor-default"
          style={{ animationDelay: "240ms" }}
        >
          <div className="flex items-center gap-3 w-full">
            <div className="stat-icon w-10 h-10 rounded-full bg-indigo-50 flex items-center justify-center shrink-0">
        ...
        <div
          className="stat-card group bg-white p-4 rounded-2xl border-2  flex flex-col items-start gap-3 shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md hover:shadow-green-100 border-green-200 cursor-default"
          style={{ animationDelay: "320ms" }}
        >
          <div className="flex items-center gap-3 w-full">
            <div className="stat-icon w-10 h-10 rounded-full bg-green-50 flex items-center justify-center shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="relative flex bg-white border border-slate-200 p-0.5 rounded-lg overflow-hidden">
              <div
              ...
              {["weekly", "monthly", "yearly"].map((filter) => (
                <button
                  ...
                  className={`relative z-10 px-4 py-1.5 text-[11px] font-bold capitalize transition-colors duration-300 ${
                    timeFilter === filter
                      ? "text-white"
